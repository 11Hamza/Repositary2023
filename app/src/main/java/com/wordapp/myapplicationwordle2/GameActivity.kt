...
import com.wordapp.myapplicationwordle2.databinding.ActivityGameBinding
import java.util.*
...
class GameActivity : AppCompatActivity() {
   ...
   /* fun randomElementFromGivenList() {
        val list = listOf("Juice","Dubai", "Clown", "Arrow")
        val randomIndex = Random.nextInt(list.size);
        val randomElement = list[randomIndex]
*/

    private val list = listOf("dubai", "juice", "clown", "doors", "fives")
